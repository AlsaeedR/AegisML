...
def run_audit(
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Return the final report plus the pipeline-specific
            # deployment context generated by Agent 1.
            # The dashboard uses this to show a dynamic attacker
            # capability instead of a hard-coded description.
            deployment_context = (
                agent_1_result
                .get("threat_model", {})
                .get("deployment_context", {})
            )
